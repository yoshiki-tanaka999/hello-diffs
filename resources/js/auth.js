...
const config = {
  ...
  loginData:      { url: 'api/auth/login',      method: 'POST',   redirect: '/index/new',     fetchUser: true     },
  logoutData:     { url: 'api/auth/logout',     method: 'POST',   redirect: '/index/new',     makeRequest: true   },
